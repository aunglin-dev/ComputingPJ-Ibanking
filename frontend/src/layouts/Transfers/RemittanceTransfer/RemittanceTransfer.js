  ...
  const validateTransfer = async () => {
    try {
      const validateModel = {
        ...
        amount: rawValue,
        NRC: `${region}/${township}/${prefix}`,
        receiverName: accountHolderName,
        reqtranType: tranType?.RemittanceTransfer,
      ...
      const res = await axios.post("/transfer/validateRemittanceTransfer", validateModel);
          ...
          <Grid item xs={12} lg={12}>
            <Card>
              <MDBox p={2} lineHeight={0}>
                <MDTypography variant="h5">Remittance Transfer</MDTypography>
                <MDTypography variant="button" color="text" fontWeight="regular">
                  Funds transfer through NRC
                </MDTypography>
              </MDBox>
              <MDBox p={2}>
              ...
              <List sx={{ pl: 4 }}>
                  ...
                  <ListItemText
                    primary={
                      <MDTypography variant="button" fontWeight="regular">
                        Please carefully double-check the Beneficiary NRC Number
                      </MDTypography>
                    }
                  />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary={
                      <MDTypography variant="button" fontWeight="regular">
                        Beneficiary NRC , Email, and Mobile Number before transferring money
                      </MDTypography>
                    }
                  />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary={
                      <MDTypography variant="button" fontWeight="regular">
                        If NRC or name is incorrect, you will be responsible for the transaction.
                      </MDTypography>
                    }
                  />
                </ListItem>
