...
const scheduledTransferEmailForOtherBank = (scheduleitem) => {
  return {
    subject: `Scheduled Transfer Confirmation - ${scheduleitem.TransactionId}`,
    text: `Dear ${scheduleitem.ToAccountName},
  ...
  SMEDB Team`,
    html: `
              <div style="font-family: Arial, sans-serif; line-height: 1.6;">
                  <p>Dear ${scheduleitem.ToAccountName},</p>
...
export { scheduledTransferEmail, scheduledTransferEmailForOtherBank };
