...
function ValidateRemittanceTransfer() {
  ...
  const validateTransfer = async () => {
    try {
      ...
      const res = await axios.post("/transfer/confirmRemittanceTransfer", validateModel);
...
export default ValidateRemittanceTransfer;
