...
function ScheduleValidateOtherBankTransfer() {
  ...
  const validateTransfer = async () => {
    try {
      ...
      const res = await axios.post("/otherbank/confirmOtherBankTransfer", validateModel);
            ...
            <Card>
              <MDBox p={2} lineHeight={0}>
                ...
                <MDTypography variant="button" color="text" fontWeight="regular">
                  Transfering Funds to other banks over Schedule
                </MDTypography>
              </MDBox>
              <MDBox p={5}>
...
export default ScheduleValidateOtherBankTransfer;
